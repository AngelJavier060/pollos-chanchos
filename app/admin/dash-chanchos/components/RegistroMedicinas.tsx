...
const RegistroMedicamentosChanchos = () => {
    ...
    <div className="p-8 bg-gray-50 min-h-screen flex justify-center items-center">
      <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-3xl">
        <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Registro de Medicamentos para Chanchos {/* Cambié "Pollos" por "Chanchos" */}
        </h1>
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="col-span-1">
            ...
            >
              ...
              <option value="Antivíticos para Chanchos Enfermos">
                Antivíticos para Chanchos Enfermos
              </option>
            </select>
          </div>
...
export default RegistroMedicamentosChanchos; 
